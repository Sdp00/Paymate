...
export const TESTIMONIALS = [
  {
    quote:
      "With Paymate, I finally stopped getting confused about who paid for what!",
    name: "V Aditya",
    image: "/testimonials/aditya.png",
    role: "Rental Property Manager",
  },
  {
    quote:
      "Paymate's calculations are so accurate, they're even better than my scheme to double money in 25 days!",
    name: "Prathik",
    image: "/testimonials/prathik.png",
    role: "Stock Market Expert",
  },
  {
    quote:
      "If that I have Paymate, Gulshan wont get away with selling my shoes and coat! I'll add to his debt!",
    name: "Varun SS",
